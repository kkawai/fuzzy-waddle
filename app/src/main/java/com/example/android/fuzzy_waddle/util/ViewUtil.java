...
import com.example.android.fuzzy_waddle.concurrent.ListenableFuture;
import com.example.android.fuzzy_waddle.concurrent.SettableFuture;
import com.example.android.fuzzy_waddle.ui.Stub;
...
public class ViewUtil {
  ...
  public static void setTextViewGravityStart(final @NonNull TextView textView, @NonNull Context context) {
    if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
      if (getLayoutDirection(context) == View.LAYOUT_DIRECTION_RTL) {
  ...
  public static void mirrorIfRtl(View view, Context context) {
    if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1 &&
        getLayoutDirection(context) == View.LAYOUT_DIRECTION_RTL) {
      view.setScaleX(-1.0f);
    }
  }
